...
@WebServlet("/totalbymonth")
public class TotalByMonthServlet extends HttpServlet {
    //各类分数
    Integer humscore = 0;
    Integer suduscore = 0;
    Integer temscore = 0;
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (isvalid(req)){
            ...
            //查询到该周的数据
            ResultHolder resultHolder = service.queryByMonth(yeari, monthi, number);
            ...
            //跳回输入界面
            req.getRequestDispatcher("totalbymonth.jsp").forward(req,resp);
        }
