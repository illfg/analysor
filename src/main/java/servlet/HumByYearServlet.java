...
@WebServlet("/humbyyear")
public class HumByYearServlet extends HttpServlet {
    Integer score = 0;
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (isvalid(req)){
            ...
            //根据得分获取评价(因为求出的年平均并没有具体月数，故着填7月)
            String comment = getComment("7",ave);
            //跳转到结果页
            ...
            //跳回输入界面
            req.getRequestDispatcher("humbyyear.jsp").forward(req,resp);
        }
