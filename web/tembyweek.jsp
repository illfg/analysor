...
<div class = "container-fluid; padding: 0px" >
    <br>
    <h1 style="text-align: center">温度舒适度按周查询</h1>
    ...
    <div class="container-fluid">
        <div class="container-fluid">
            ...
            <div class="col-md-5" id="notifyBody">
                <br><br><br><br>
                <form action="/tembyweek" method="post">
                    <%
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li style="font-size: 80%">
                            <a href="tembyweek.jsp" style="font-size: 150%;">按周查询温度舒适度</a>
                        </li>
                        <br>
                        <li style="font-size: 80%">
                            <a href="tembymonth.jsp" style="font-size: 150%;">按月查询温度舒适度</a>
                        </li>
                        <br>
                        <li style="font-size: 80%">
                            <a href="tembyyear.jsp" style="font-size: 150%;">查询一年内温度舒适度</a>
                        </li>
                    </ul>
                </div>
