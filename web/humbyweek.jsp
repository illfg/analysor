...
<nav class="navbar navbar-default" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
            ...
            <li class="active" style="margin-left: 45%;position: absolute">
...
<div class = "container-fluid; padding: 0px" >
    <br>
    <h1 style="text-align: center">湿度舒适度按周查询</h1>
    ...
    <div class="container-fluid">
        <div class="container-fluid">
            ...
            <div class="col-md-5" id="notifyBody">
                <br><br><br><br>
                <form action="/humbyweek" method="post">
                    <%
                    ...
                    <p style="margin-top: 20px">请选择想要查询的周数</p>
                    <div>
                        <label class="radio-inline">
                            <input type="radio" name="week" id="start1" value="1" checked> 第一周
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="week" id="start2" value="2" checked> 第二周
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="week" id="start3" value="3" checked> 第三周
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="week" id="start4" value="4" checked> 第四周
                        </label>
                    </div>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li style="font-size: 80%">
                            <a href="humbyweek.jsp" style="font-size: 150%;">按周查询湿度舒适度</a>
                        </li>
                        <br>
                        <li style="font-size: 80%">
                            <a href="humbymonth.jsp" style="font-size: 150%;">按月查询湿度舒适度</a>
                        </li>
                        <br>
                        <li style="font-size: 80%">
                            <a href="humbyyear.jsp" style="font-size: 150%;">查询一年内湿度舒适度</a>
                        </li>
                    </ul>
                </div>
