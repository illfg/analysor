...
<div style="width: 70%;margin-left: 15%">
    ...
    <p style="margin-top: 100px">加速度数据输入</p>
    <%
        //如果request域中有sudo属性说明刚刚的有提交，需要将结果信息显示出来
        String info = (String) request.getAttribute("sudu");
        if (info !=null && !"".equals(info)){
    %>
    <p style="text-align: center"><%=info%></p>
    <%
            //信息打印后应该移除，避免重复打印
            request.removeAttribute("sudu");
        }
    %>
    <form action="/suduInsert" method="post" style="width: 60%">
        ...
        <input style="margin-top: 20px" class="form-control" type="text" placeholder="加速度值" name="acc40">
